	  ...
	  function loadMarkers(){
		  ...
		  Markers.getMarkers().then(function(markers){
			...
			for (var i = 0; i < records.length; i++) {
	          ...
	          angular.element(document.getElementById('listContainer')).append($compile("<li class='listviewstyle'><div class='list-img'><img class='list-imglink' src='/img/placeholders/referral-image.jpg'></div><div class='list-infocont'><span><p class='listwindow-name'>"+record.name+"</p><div class='infowindow'></span><p><span class='info-subheader'>Date referred</span> "+record.referdate+"</p><p><span class='info-subheader'>gender</span>: "+record.gender+"</p><button ng-click='toggleDetails("+i+")' onclick='gotoLocation("+record.lat+","+record.lng+")' class='listmapbutton'>View Details</button></div></div></li>")($scope));
